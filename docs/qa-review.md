...
The current branch's mechanical recount is 498 scenarios across 67 feature files:
389 active, 0 `@quarantine`, 109 `@future`/`@pending`/`@hardware_blocked`. The five active
