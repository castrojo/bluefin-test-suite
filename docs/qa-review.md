...
The current branch's mechanical recount is 492 scenarios across 64 feature files:
387 active, 0 `@quarantine`, 105 `@future`/`@pending`/`@hardware_blocked`. The five active
