...
The current branch's mechanical recount is 491 scenarios across 64 feature files:
387 active, 0 `@quarantine`, 104 `@future`/`@pending`/`@hardware_blocked`. The five active
