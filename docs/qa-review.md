...
- `kde-smoke`: 13 `@informational` scenarios in one feature file; Aurora-only Phase-2 harness proof. Depends on sibling PRs #641-#645 for shared KDE helpers and `e2e.yml` suite registration.
