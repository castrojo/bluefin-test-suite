...
503 scenarios across 68 feature files: 392 active, 0 quarantined, 111 `@future`/`@pending`/`@hardware_blocked`
(mechanical recount 2026-08-07 after the quarantine-debt cleanup in #679; +4 `@pending` `bctl.feature`
scenarios added ahead of the design-gated CI infra in #487; +3 `common_devmode.feature` scenarios in #724).
