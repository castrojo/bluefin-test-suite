...
SUITE_NOTES: dict[str, str] = {
    ...
    "homebrew": (
        ...
        "and ChairLift managed-cask/config/UI integration; runs through the "
        "lab's run-systemd-container-tests template, which unmasks "
        "brew-setup.service (the QEMU e2e action keeps it masked)"
    ),
