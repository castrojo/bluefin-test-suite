...
SUITE_NOTES: dict[str, str] = {
    ...
    "homebrew": (
        ...
        "and ChairLift managed-cask/config/UI integration; runs only through "
        "the lab's run-systemd-container-tests template (not the QEMU e2e "
        "action, which masks brew-setup.service)"
    ),
