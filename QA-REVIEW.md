...
Current audit: 269 scenarios across 32 feature files (last audit: 2026-06-05). 27 quarantined, 239 active, 3 @future stubs.
...
428 unit tests across 27 files (`tests/unit/`). Run with `python3 -m pytest tests/unit/ -q`.
