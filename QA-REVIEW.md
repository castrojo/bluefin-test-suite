...
Current audit: 269 scenarios across 32 feature files (last audit: 2026-06-05). 32 quarantined, 237 active, 3 @future stubs.
...
482 unit tests across 32 files (`tests/unit/`). Run with `python3 -m pytest tests/unit/ -q`.
